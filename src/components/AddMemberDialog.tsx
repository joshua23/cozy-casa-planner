...
export function AddMemberDialog({ teamId, children, onMemberAdded }: AddMemberDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Here you would add the member to Supabase
      toast({
        title: "添加成功",
        description: `成员 ${formData.name} 已添加到团队`,
      });
      setOpen(false);
      setFormData({
        name: "",
