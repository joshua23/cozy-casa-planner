          ...
          <div className="bg-card rounded-lg p-4 shadow-card border border-border/50">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{workingTeams}</p>
              </div>
          ...
          <div className="bg-card rounded-lg p-4 shadow-card border border-border/50">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-foreground">{avgEfficiency}星</p>
              </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                      ...
                      <div className="text-center p-3 bg-muted/30 rounded-lg">
                        ...
                        <p className="text-lg font-semibold text-foreground">{team.pricing_model || "未设定"}</p>
                      </div>
                      <div className="text-center p-3 bg-muted/30 rounded-lg">
                        <p className="text-sm text-muted-foreground">效率评级</p>
                        <span className={`px-2 py-1 rounded text-sm font-medium ${getEfficiencyColor(team.efficiency_rating || 0)}`}>
                          {team.efficiency_rating || 0}星
                        </span>
                      </div>
                      <div className="text-center p-3 bg-muted/30 rounded-lg">
                        <p className="text-sm text-muted-foreground">联系电话</p>
                        <p className="text-lg font-semibold text-foreground">{team.team_leader_phone || "未设定"}</p>
                      </div>
                    </div>
